...
import JavaScriptIcon from "./components/Javascript-icon";
          ...
          <div className="lg:col-span-5 lg:px-8">
            <div className="relative">
              ...
              <Image
                ...
                width={0}
                sizes="100vw"
                style={{ height: "auto", width: "100%", aspectRatio:"455/512" }}
      ...
      <div className="container md:mt-24 mt-16">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
          {expertiseData.map((item, index) => {
            return (
              <div
                className="flex group shadow cursor-pointer shadow-gray-200 dark:shadow-gray-800 dark:hover:shadow-gray-700 items-center p-3 rounded-lg bg-white dark:bg-slate-900 "
                key={index}
              >
